...
namespace Language_en {
  ...
  LSTR MSG_BED_TRAMMING_MANUAL            = _UxGT("Manual Bed Leveling");
  ...
  LSTR MSG_UBL_BUILD_MESH_MENU            = _UxGT("Create New Mesh");
  ...
  LSTR MSG_STORED_FAN_N                   = _UxGT("Saved Fan ~");
  ...
  LSTR MSG_STORE_EEPROM                   = _UxGT("Save Settings");
  ...
  LSTR MSG_SETTINGS_STORED                = _UxGT("Settings Saved");
  ...
  // Extra strings for JyersUI
    ...
    LSTR MSG_LCD_TILTING_GRID_SIZE          = _UxGT("Tilting Grid Size");
    ...
    LSTR MSG_CORNER_HIGH                    = _UxGT("Corner is ++ %s mm");
    LSTR MSG_CORNER_LOW                     = _UxGT("Corner is -- %s mm");
