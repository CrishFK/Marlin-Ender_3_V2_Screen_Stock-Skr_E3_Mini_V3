...
#define STRING_CONFIG_H_AUTHOR "CrishFK" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CrishFK 3D Beta Software"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -13, 0 }
